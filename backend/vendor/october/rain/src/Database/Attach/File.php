...
class File extends Model
{
    ...
    public function beforeSave()
    {
        ...
        // dd ($tinify->se);
        //
        // $token = base64_encode('api:39tZCFVyf6WfycVqYGlqLfTxmtwBQgHt');
        //
        // $url = 'https://api.tinify.com/shrink/';
        // // $post_fields = array(
        // //     new CURLFile($this->getLocalPath()),
        // // );
        //
        // $ch = curl_init($url);
     ...
     * @return string
     */
    protected function compressWithTinyPng(): void
    {
        dd($this);

        // try {
        //     Tinify::setKey('39tZCFVyf6WfycVqYGlqLfTxmtwBQgHt');
        //
